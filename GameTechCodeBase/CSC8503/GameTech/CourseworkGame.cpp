...
void CourseworkGame::InitSurfaces() {
	//starter floors
	AddFloorToWorld(Vector3(70, -2, 0), Vector3(80,2,50));
	...
	//maze floor
	AddFloorToWorld(Vector3(362.5, -2, 0), Vector3(102.5, 2, 80));
	//maze opening
	AddFloorToWorld(Vector3(295, 10, -50), Vector3(5, 10, 30));
	AddFloorToWorld(Vector3(295, 10, 50), Vector3(5, 10, 30));
	//maze wiggle walls
	AddFloorToWorld(Vector3(320, 10, -50), Vector3(20, 10, 5));
	AddFloorToWorld(Vector3(320, 10, 25), Vector3(20, 10, 5));
	AddFloorToWorld(Vector3(340, 10, 50), Vector3(20, 10, 5));
	//maze middle wall
	AddFloorToWorld(Vector3(360, 10, 0), Vector3(5, 10, 55));
	//maze middle opening
	AddFloorToWorld(Vector3(385, 10, -50), Vector3(5, 10, 30));
	AddFloorToWorld(Vector3(385, 10, 50), Vector3(5, 10, 30));
	//maze end wall
	AddFloorToWorld(Vector3(420,10,0), Vector3(5,10,55));
	//maze end opening
	AddFloorToWorld(Vector3(460, 10, 50), Vector3(5, 10, 30));
	AddFloorToWorld(Vector3(460, 10, -50), Vector3(5, 10, 30));

	//final stretch
	AddFloorToWorld(Vector3(540, -2, 0), Vector3(75, 2, 6));

	//end platform
	AddFloorToWorld(Vector3(700, -2, 0), Vector3(85, 2, 80));

	//finishline (cheating by making finish posts with floors)
	AddFloorToWorld(Vector3(675, 20, 50), Vector3(4, 20, 4));
	AddFloorToWorld(Vector3(675, 20, -50), Vector3(4, 20, 4));
}
...
void CourseworkGame::UpdatePlayer() {
...
void CourseworkGame::UpdatePlayerKeys() {
	/*
...
void CourseworkGame::UpdatePlayerCamera() {
	...
	*/
	...
	if (world->Raycast(playerToIdealCam, closestCollision, true)) {
